...
class Settings {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) {
    return Settings(
      ...
      textDecoration: CustomTextDecoration.values[json['textDecoration'] ?? CustomTextDecoration.none.index],
      containerPadding: (json['containerPadding'] ?? 3.0).toDouble(),
      containerMargin: (json['containerMargin'] ?? 3.0).toDouble(),
      containerBorderColor: Color(json['containerBorderColor'] ?? Colors.transparent.value),
