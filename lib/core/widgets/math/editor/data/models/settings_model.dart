...
class Settings {
  ...
  Settings({
    ...
    this.textDecoration = CustomTextDecoration.none, 
  ...
  factory Settings.fromJson(Map<String, dynamic> json) {
    return Settings(
      ...
      expressionColor: Color(json['expressionColor'] ?? Colors.black.toARGB32()),
      backgroundColor: Color(json['backgroundColor'] ?? Colors.white.toARGB32()),
      mathStyle: math_fork.MathStyle.values[json['mathStyle'] ?? 0],
      fontWeight: FontWeight.values.firstWhere((e) => (e.value / 100).round() == (json['fontWeight'] ?? 4), orElse: () => FontWeight.normal),
      fontStyle: FontStyle.values[json['fontStyle'] ?? 0],
      textDecoration: CustomTextDecoration.values[json['textDecoration'] ?? 0],
      containerPadding: (json['containerPadding'] ?? 3.0).toDouble(),
      containerMargin: (json['containerMargin'] ?? 3.0).toDouble(),
      containerBorderColor: Color(json['containerBorderColor'] ?? Colors.transparent.toARGB32()),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'fontSize': fontSize,
      'expressionColor': expressionColor.toARGB32(),
      'backgroundColor': backgroundColor.toARGB32(),
      'mathStyle': mathStyle.index,
      'fontWeight': (fontWeight.value / 100).round(),
      'fontStyle': fontStyle.index,
      'textDecoration': textDecoration.index, 
      'containerPadding': containerPadding,
      'containerMargin': containerMargin,
      'containerBorderColor': containerBorderColor.toARGB32(),
  ...
  Settings copyWith({
    ...
    return Settings(
      ...
      enableInlineSuggestions: enableInlineSuggestions ?? this.enableInlineSuggestions,
