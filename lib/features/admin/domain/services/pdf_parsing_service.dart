...
8. يجب عليك كتابة كافة الرموز العلمية، الرياضية، الكيميائية، المتغيرات (مثل t أو x أو n)، الأرقام، الوحدات العلمية (مثل sec أو mol أو J)، الصيغ الكيميائية (مثل H2O)، والمعادلات المذكورة في نص الشرح والخطوات مغلفة بتنسيق LaTeX حصراً (باستخدام علامة الدولار المفردة \$ للرموز المدمجة في السطر مثل \$ x \$ أو \$ H_2O \$ أو \$ t_{1/2} \$ أو \$ 231\\text{ sec} \$، وعلامة الدولار المزدوجة \$\$ للمعادلات المستقلة والسطرية الكبيرة). ويمنع منعاً باتاً استخدام وسم الكيمياء \\ce{...} في كتابة التفاعلات والصيغ الكيميائية، وبدلاً من ذلك اكتب الصيغ والتفاعلات كرموز ومعادلات رياضية قياسية في LaTeX مثل \$ NH_4^+ \$ و \$ H_2O \$ والسهم المتزن \$ \\rightleftharpoons \$ والسهم أحادي الاتجاه \$ \\rightarrow \$.
