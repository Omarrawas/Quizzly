...
class _ManageCodesScreenState extends State<ManageCodesScreen> {
  int _selectedIndex = 0; // 0: الاشتراكات المدفوعة, 1: الاشتراكات المجانية
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return _buildEmptyState(
            ...
            isPaid
                ? 'لا توجد اشتراكات مدفوعة حالياً'
                : 'لا توجد اشتراكات مجانية حالياً',
            isDark,
          );
        }
  ...
  void _confirmDeleteActivation(String id, bool isDark) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'هل أنت متأكد من حذف هذا الاشتراك؟ سيتم قفل المادة عند المستخدم فوراً.',
          style: GoogleFonts.cairo(
